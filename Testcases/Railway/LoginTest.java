...
public class LoginTest extends BaseTest {
	...
	public void TC02() {
		...
		Account userBlankUsername = new Account(Constant.BLANK_VALUE, Constant.VALID_PASSWORD, Constant.VALID_PID);
	...
	public void TC03() {
		...
		Account userInvalidPassword = new Account(Constant.VALID_EMAIL, Constant.INVALID_PASSWORD, Constant.VALID_PID);
		String expectedMsg = "There was a problem with your login and/or errors exist in your form.";
	...
	public void TC05() {
		...
		Account userInactivatedUsername = new Account(Constant.INVALID_EMAIL, Constant.VALID_PASSWORD, Constant.VALID_PID);
